...
namespace GraniteHouse.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        // The BindProperty directive on ProductsVM makes it so that we do not
        // have to pass the ProductsVM into the Action Methods
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            return View(ProductsVM);
            //if (id != productsViewModel.Products.Id)
            //{
            //    return NotFound();
            //}

            //if (productsViewModel.Products)
